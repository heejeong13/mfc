...
function RoomInfo({
  ...
  useEffect( ()=> {
    ...
    console.log(playerA?.nickName);
    console.log(playerB?.nickName);
    ...
    <>
      ...
      <Row>
        ...
        <span>&nbsp;</span>
          ...
          <span>무 0&nbsp; {playerA && playerA.nickName ? (
        <span>{playerA.drawCount}&nbsp;</span>
        ) : (
        <span>&nbsp;</span>
        )}</span>
          <span>패 0&nbsp; {playerA && playerA.nickName ? (
        ...
        <span>&nbsp;</span>
          ...
          <span>
            승률 {playerB && playerB.nickName ? (
        <span>{playerB.winRate}%&nbsp;</span>
        ) : (
        <span>&nbsp;</span>
        )}
          </span>
